...
def remove(text):
  ...
  return t #전처리 완료 이후 리스트값 반환

@app.route('/nlp', methods=['POST'])
def hello():
  req = request.get_json()
  print( req['TEXT'])
  return remove(req['TEXT'])
